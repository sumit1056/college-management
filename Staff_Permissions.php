...
//         echo "Role Name: " . $row["Permissionsrole"] . "<br>";
//         echo "Name: " . $row["Permissionsname"] . "<br>";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <form>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><!--<input type="checkbox" id="dashboard_add">--><i class="fa-solid fa-xmark"></i></td>
                                <td><!--<input type="checkbox" id="dashboard_edit">--><i class="fa-solid fa-xmark"></i></td>
                                <td><!--<input type="checkbox" id="dashboard_delete">--><i class="fa-solid fa-xmark"></i></td>
                            ...
                            <tr>
                                ...
                                <td><!--<input type="checkbox" id="permissions_edit">--><i class="fa-solid fa-xmark"></i></td>
                                <td><!--<input type="checkbox" id="permissions_delete">--><i class="fa-solid fa-xmark"></i></td>
                                <td><!--<input type="checkbox" id="permissions_export">--><i class="fa-solid fa-xmark"></i></td>
                            </tr>
                        </table>
                        <div class="line"></div>
                        <div class="buttons saveandcancle" style="text-align: left;">
                            <button type="button" onclick="clearForm()" class="clearbutton">Clear</button>
            ...
            <script>
                ...
                function getValues() {
                    ...
                    // Check if either role or name is not selected
                    if (roleName === '') {
                        // Display the role error message
                        roleError.innerHTML = 'Please select a role.';
                        return; // Stop execution if either role or name is not selected
                    }

                    // Clear the error messages if both role and name are selected
                    roleError.innerHTML = '';
                    nameError.innerHTML = '';

                    var allCheckboxValues = [roleName, name];
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Permissions_data.php",
                        data: {
                            allCheckboxValues: JSON.stringify(allCheckboxValues)
                        },
                        success: function(response) {
                            ...
                            Swal.fire({
                                ...
                                //     // Close the popup after the user confirms the alert
                                //     closePopup();
                                // }
                            });
                        },
                ...
                function clearForm() {
                    // Clear role and name select elements
                    document.getElementById("select_role").value = '';
